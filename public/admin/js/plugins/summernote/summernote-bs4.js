...
$$1.extend($$1.summernote.lang, {
    ...
    'zh-CN': {
        ...
        image: {
            ...
            maximumFileSizeError: '超过了最大文件大小.',
            url: '图片URL',
            remove: '删除图像',
            original: '原件'
        },
        ...
        help: {
            ...
            'outdent': '当前段落突出显示',
            'indent': '当前段落缩进',
            'formatPara': '当前块改为段落(P 标签)',
            'formatH1': '设置为标题 1格式 H1',
            'formatH2': '设置为标题 2格式 H2',
            'formatH3': '设置为标题 3格式 H3',
            'formatH4': '设置为标题 4格式 H4',
            'formatH5': '设置为标题 5格式 H5',
            'formatH6': '设置为标题 6格式 H6',
